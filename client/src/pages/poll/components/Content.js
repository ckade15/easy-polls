    ...
    return (
        <section className='bg-[#AF4D98] w-full min-h-screen text-center font-mono pt-20 '>
            <div className='w-1/2 min-w-[500px] bg-[#9DF7E5] ml-auto mr-auto rounded-md p-10 flex-col justify-center place-items-center pb-20 pt-20'>
                ...
                {props.loading ? <>
                <div role="status" className='w-full flex-col text-center justify-center place-items-center p-10'>
                    <svg aria-hidden="true" className=" w-10 h-10 text-gray-200 animate-spin dark:text-gray-400 fill-[#AF4D98] ml-auto mr-auto" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
