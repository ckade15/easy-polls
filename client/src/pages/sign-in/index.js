    ...
    return (
        <section className="bg-[#9DF7E5] w-full h-screen flex place-items-center font-mono">
            <form className="bg-[#F4E4BA] w-1/3 ml-auto mr-auto flex-col align-center p-5 h-fit rounded-md shadow-2xl min-w-[400px]">
                ...
                <input id="email" name="email" type="email" placeholder="Email" className="flex min-w-[250px] mr-auto ml-auto mt-5 rounded-md p-1 shadow-md " onChange={e => handleState(e)}/>
                ...
                <div className="m-0 p-0 flex w-3/4  ml-auto mr-auto place-items-center justify-center mt-4 ">
                    <input id="password" name="password" type="password" placeholder="Password" className="min-w-[250px] ml-10 rounded-md p-1 shadow-md " onChange={e => handleState(e)}/>
