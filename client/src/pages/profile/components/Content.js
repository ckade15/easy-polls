    ...
    return (
        <main className='w-full h-screen bg-[#AF4D98] pt-10'>
            <section className='w-1/2 ml-auto mr-auto bg-blue-200 rounded-md min-h-[450px] h-auto flex-col justify-center p-5'>
                ...
                <Input name='firstName' title='First Name:' val={context.firstName} id={context.id} setContext={setContext}/>
                <Input name='lastName' title='Last Name:' val={context.lastName} id={context.id} setContext={setContext}/>
                <Input name='email' title='Email:' val={context.email} id={context._id} setContext={setContext}/>
